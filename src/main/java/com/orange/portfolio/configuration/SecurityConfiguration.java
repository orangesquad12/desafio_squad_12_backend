    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize ->  authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/project/image/{id}").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/project/{id}").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/project/{id}").authenticated()
